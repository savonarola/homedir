...
xml_grep --text_only '//original_image' <(scrot -s /tmp/imgur.png && curl --form key=a4ec53d0a3f09f034a6629767ea86e85 --form image=@/tmp/imgur.png 'http://imgur.com/api/upload.xml' -s) | xsel -i -b && notify-send 'Screenshot uploaded'
